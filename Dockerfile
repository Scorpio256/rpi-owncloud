...
RUN apt-get install -y supervisor apache2 php7.3 php7.3-gd php-xml-parser php7.3-intl php7.3-sqlite mariadb-server-10.3 smbclient curl libcurl3 php7.3-mysql php7.3-curl bzip2 wget vim openssl ssl-cert sharutils
