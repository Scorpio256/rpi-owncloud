...
RUN apt-get install -y supervisor apache2 php php-gd php-xml-parser php-intl php-sqlite mariadb-server-10.3 smbclient curl libcurl3 php-mysql php-curl bzip2 wget vim openssl ssl-cert sharutils
